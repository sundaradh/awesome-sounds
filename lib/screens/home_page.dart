...
class _HomePageState extends State<HomePage> {
  ...
  bool _videoLoadingFailed = false;
  ...
  Future<void> _videoLoadingTimeout() async {
    await Future.delayed(
        const Duration(seconds: 5)); // Adjust the timeout duration as needed
  ...
  Future<void> _refresh() async {
    // Add your refresh logic here, for example, reload the whole page
  ...
  void _initConnectivity() async {
    ...
    _updateConnectivity(_connectivityResult);
  }
  ...
  void _updateConnectivity(ConnectivityResult result) {
    ...
    // Check connectivity and load the video if connected
    if (_connectivityResult == ConnectivityResult.mobile ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: const Text(
            "Check your internet connection for YouTube Video",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: _refresh, // Provide the refresh callback
